...
class Card extends Component {
  ...
  CardStub(props) {
    ...
    return (
      ...
      >
        {/* Card name */}
        <div className="truncated-text">{card.getName()}</div>
        {/* Card image */}
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {card.getName()}
            <div className="truncated-text-tooltip">{card.getName()}</div>
          </div>
          <div
            style={{
              "font-size": "0.5rem",
        ...
        >
          ...
          >
            {card.getType()}
            <div className="truncated-text-tooltip">{card.getType()}</div>
          </div>
          <div
            style={{
              flex: "1",
        ...
        <div className="card-text">
          {card.getCardText()}
          <div className="card-text-tooltip">{card.getCardText()}</div>
        </div>
        {/* Power/Toughness */}
        <div
          style={{
